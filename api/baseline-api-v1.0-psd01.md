      ...
      requestBody:
        content:
          application/json:
            ...
            example:
              owners: 
                - 'did:bsln:7cb23e2b-07ed-4562-8afb-73955f8f17c5'
              security_policies:
    ...
    get:
      ...
      parameters:
        - description: 'ID of a specific `Subject` for which detailed information is desired'
          ...
          schema:
            type: string
          example: 'did:bsln:331156fb-fa5c-4557-ac39-69ae34c72c18'
      responses:
        '200':
          content:
            application/json:
    ...
    put:
      ...
      parameters:
        - description: 'ID of a specific `Subject` to be updated; _UUID as specified by RFC4122_'
          ...
          schema:
            type: string
          example: 'did:bsln:99c404e9-fe10-4ca7-b787-d5943d03591c'
      requestBody:
        content:
          application/json:
            schema:
    ...
    get:
      ...
      parameters:
        - description: 'ID of a specific `SubjectAccount` for which a list of  `SubjectAccount` objects is desired'
          ...
          schema:
            type: string
          example: 'did:bsln:648142fb-fa5c-4557-ac39-69ae34c72c18'
    ...
    post:
      ...
      requestBody:
        content:
          application/json:
            example:
              subject_id: 'did:bsln:93229a14-5e13-4c45-8352-3ad9948b8ae3'
              ...
              security_policies: []
              admins: 
                - 'did:bsln:93229a14-5e13-4c45-8352-3ad9948b8ae3'
            schema:
              $ref: '#/components/schemas/Workgroup'
        required: true
      responses:
    ...
    get:
      ...
      parameters: 
        - description: ID of a specific DID to be resolved
          ...
          schema:
            type: string
          example: 'did:bsln:8def7853-245b-4743-b702-984417a8ba2f'
      responses:
        '200':
          ...
          content:
            application/json; charset=UTF-8:
              ...
              example: 
                ...
                id: 'did:bsln:54dc7f20-f2ae-49ff-93ab-c3857c64600a'
                verificationMethod:
                  - controller: 'did:bsln:54dc7f20-f2ae-49ff-93ab-c3857c64600a'
                    id: 'did:bsln:54dc7f20-f2ae-49ff-93ab-c3857c64600a#a3:c2:e5:17:c2:19:26:3c:fa:a2:2c:38:7b:ca:0c:60'
                    publicKeyJwk:
                ...
                type: JsonWebKey2020
                assertionMethod:
                  'did:bsln:54dc7f20-f2ae-49ff-93ab-c3857c64600a#a3:c2:e5:17:c2:19:26:3c:fa:a2:2c:38:7b:ca:0c:60'
                authentication:
                  'did:bsln:54dc7f20-f2ae-49ff-93ab-c3857c64600a#a3:c2:e5:17:c2:19:26:3c:fa:a2:2c:38:7b:ca:0c:60'
                capabilityInvocation:
                  'did:bsln:54dc7f20-f2ae-49ff-93ab-c3857c64600a#a3:c2:e5:17:c2:19:26:3c:fa:a2:2c:38:7b:ca:0c:60'
...
```
    Subject:
      example:
        ...
        description: 'Organization for testing'
        id: 'did:bsln:a7e165dd-2d91-4f1e-b025-6ef2c5514603'
        metadata: {}
        name: 'ACME Inc.'
        type: 'Organization'
      description: |- 
      ...
      properties:
        ...
        id:
          ...
          example: 'did:bsln:93229a14-5e13-4c45-8352-3ad9948b8ae3'
          readOnly: true
          type: string
        metadata:
          nullable: true
    ...
    SubjectAccount:
      ...
      properties:
        ...
        id:
          ...
          example: 'did:bsln:4A252b7e30f6cD6a85d20476Bb291Ef7f3a05293'
          type: string
          readOnly: true
        bpi_account_ids:
          type: array
...
```
    Wallet:
      ...
      example:
        ...
        purpose: 44
        subject_id: 'did:bsln:7c8fe6f1-38c3-4da1-b4b7-7591c6d0ca7c'
...
```
    Workgroup:
      ...
      example:
        ...
        id: 'did:bsln:bdf94fc0-63ad-4ee9-ac75-7eb63365d0f6'
        name: 'Example Workgroup'
        network_id: '07102258-5e49-480e-86af-6d0c3260827d'
        type: 'baseline'
        security_policies: []
      ...
      properties:
        ...
        id:
          ...
          example: 'did:bsln:bdf94fc0-63ad-4ee9-ac75-7eb63365d0f6'
          minLength: 1
          readOnly: true
          type: string
        name:
